...
/// When a specific quantity's kind inherits this trait `ops::Add` is implemented automatically.
pub trait Add {}
...
/// Trait to denote that a quantity is able to be subtracted with a quantity of the same
/// dimensions. When a specific quantity's kind inherits this trait `ops::SubAssign` is implemented
/// automatically.
pub trait SubAssign {}
...
/// Trait to denote that a quantity is able to be multiplied with a quantity of the same
/// dimensions. When a specific quantity's kind inherits this trait `ops::MulAssign` is implemented
/// automatically.
pub trait MulAssign {}

/// Trait to denote that a quantity is able to be divided with a quantity of the same dimensions.
...
/// dimensions. When a specific quantity's kind inherits this trait `ops::Rem` is implemented
/// automatically.
pub trait Rem {}

/// Trait to denote that a quantity is able to calculate a remainder with a quantity of the same
/// dimensions. When a specific quantity's kind inherits this trait `ops::RemAssign` is implemented
/// automatically.
pub trait RemAssign {}

/// Trait to denote that a quantity is able to perform saturating additions and subtractions with a
/// quantity of the same dimensions. When a specific quantity's kind inherits this trait
